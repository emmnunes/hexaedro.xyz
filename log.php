...
<title><?php echo _("Log"); ?> – Hexaedro</title>
...
<body>
    	...
    	<div class="goback">
        	<div class="cat-icon">
                <a href="index.php?locale=<?php echo($locale); ?>">
					<p>Menu</p>
					<img src="img/log-mini.png" alt="Log" class="cat-mini" />
                </a>
            </div>
        </div>
    </div>
    ...
    <div class="page" id="about">
	    <div class="page-wrapper preload">
            ...
            <iframe src="http://log.hexaedro.eu" class="log"></iframe>
            ...
            <div class="mobile">
                <div class="greycontainer">
                        ...
                        <div class="hexagrid">   
                            <div class="row logmobile">
                            	<h1><?php echo _("You can follow the project updates through our tumblr, at"); ?> <a href="http://log.hexaedro.eu">log.hexaedro.eu</a></h1>
                            </div>
                        </div>
				</div>
                ...
                <div class="footer">
                    <div class="footmenu">
                    	...
                    	<li class="selected"><a href="log.php?locale=<?php echo($locale); ?>"><?php echo _("Log"); ?></a></li>
